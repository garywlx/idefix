...
public:
	...
	inline void setSpread(const double spread){
		m_spread = m_spread != spread ? spread : m_spread;
	}
	...
	inline void setSendingTime(const string sending_time){
		m_sending_time = m_sending_time != sending_time ? sending_time : m_sending_time;
	}
